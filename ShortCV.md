...
* To surround myself with people smarter than me, and elevate their work

## Expertise
 * 25 years of experience building and using spatial data, technology and methods for research and teaching
 * Discovery, access and services for data collections
 * Planning, implementation and management of long-term data projects  
 * Design and implementation of spatial data literacy training programs
 * Design and implementation of integrated, multi-user field data collection systems
...
* Design and implementation of Stanford Geospatial Center spatial data literacy programs and curriculum
* Curation, management and vendor relations for enterprise-level data platforms, including:
  - ArcGIS Online
  - Google Earth Engine
  - Planet.com
  - SimplyAnalytics.com
...
- ##### EARTH 1B: Know Your Planet: Big Earth, Stanford University, 2018-present
- ##### Wrigley Field Program in Hawaii, Stanford School of Earth, Energy & Environmental Sciences, 2016 - present  
- ##### Stanford CESTA Summer Research College (SRC), 2015-present
...
Leading a team to automate the use of high-cadence satellite imagery and machine learning in identifying the locations of active nomadic pastoralist settlements for future public health interventions.  
...
Geo4LibCamp is an annual unconference hosted at Stanford University, meant to foster collaboration, learning and progress on spatial data services and support in libraries. The meeting is accompanied by an annual working meeting of the Geoblacklight developer community.
